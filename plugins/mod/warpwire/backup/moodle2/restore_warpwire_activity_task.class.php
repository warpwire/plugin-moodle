...
require_once($CFG->dirroot . '/mod/warpwire/backup/moodle2/restore_warpwire_stepslib.php');

/**
 * Restore task for the warpwire activity module
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_warpwire_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_warpwire_activity_structure_step('warpwire_structure', 'warpwire.xml'));
    }
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('warpwire', 'view', 'view.php?id={course_module}', '{warpwire}');
